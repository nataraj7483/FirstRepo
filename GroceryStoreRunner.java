class GroceryStoreRunner
{
	...
	{
		GroceryStore.setType("Noodles");
		GroceryStore.setShopName("Total madivala");
		GroceryStore.setPrice(3500);
		GroceryStore.setQuantity(2);
		GroceryStore.setAvailable(true);
		GroceryStore.setName1("Rice");
		GroceryStore.setItems1("flour");
		...
		String name=GroceryStore.getName1();
		String items=GroceryStore.getItems1();
		...
		{
			System.out.println("Iteam stock ide");
		}
		else
		{
			System.out.println("Iteam stock illa");
		}
